...
This script defines all constants used in the experiments.
    ...
    - XWJ_NAMES: all column names for the final "XWJ" file. (You don't have to change it)
    - XWN_NAMES: all column names for the final "XWN" file. (You don't have to change it)
    - XIN_NAMES: all column names for the final "XIN" file. (You don't have to change it)
"""
import os
